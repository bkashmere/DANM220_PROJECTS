...
GravityPoint.RADIUS_LIMIT = 2000;
...
GravityPoint.prototype = (function(o) {
    ...
    startDrag: function(dragStartPoint) {
        this._dragDistance = Q.sub(dragStartPoint, this);
        this.dragging = true;
    },
    ...
    render: function(ctx) {
        ...
        for (i = 0, len = particles.length; i < len; i++) {
            particles[i].addSpeed(Q.sub(this, particles[i]).normalize().scale(this.gravity));
        }
        ...
        for (i = 0, len = gravities.length; i < len; i++) {
            ...
            if (
                ...
                absorp = Q.sub(g, this).scale(g.radius / this.radius * 0.5);
            ...
            g.addSpeed(Q.sub(this, g).normalize().scale(this.gravity));
        }
...
/* BK changed background color to black */
/* BK changed particle radius to 1 */
/* BK changed G_point radius to 5 */
    ...
    function mouseMove(e) {
        ...
        var i, g, hit = false;
        for (i = gravities.length - 3; i >= 0; i--) {
            g = gravities[i];
...
/* BK increased particleNum to 1000 */
